...
//    tree.DeleteNodeInBST(tree.root ,9);
    ...
    cout<<"\n\nThe total leaf node in tree are: "<< tree1.leafCount(tree1.root)<<endl;
    cout<<"product is "<<tree1.product(tree1.root);
   
    cout<<"\n\nThe height of root node is : "<< tree1.treeHeight(tree1.root);
    cout<<"the smallest node is :"<<tree1.FindSmall(tree1.root);
    cout<<"total nodes are:"<<tree1.CountNodes(tree1.root);
    ...
    cout<<"\n\nThe height of root node is : "<< tree1.treeHeight(tree1.root);
    cout<<"max is:"<<tree1.FindMax(tree1.root);
...
bool BinarySearchTree::product(Node *root)
{
    ...
    int k =root->data * root->left->data || root->data * root->right->data || root->left->data * root->right->data ||
    root->right->data * root->left->data || root->left->data * root->left->data ||root->right->data * root->right->data;
    ...
    if (root->left)
        {
            leftProduct = root->left->data;
        }
        
    if (root->right)
        {
            rightProduct = root->right->data;
        }
        
    if (root->data == (leftProduct + rightProduct) && product(root->left) && product(root->right))
        {
            return true;
        }
    ...
    if(k=root->left->data * root->right->data )
    ...
    if(k=root->right->data * root->left->data )
    ...
    if(k=root->left->data * root->left->data )
    ...
    if(k=root->right->data * root->right->data )
